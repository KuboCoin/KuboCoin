...
CAmount AmountFromValue(const UniValue& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 5100000000.0) //5.1billion max RPC limit. This can be changed to your liking for your platform.
...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop kubocoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "kubocoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* kubocoin features */
    //    {"kubocoin", "masternode", &masternode, true, true, false},
        {"kubocoin", "listmasternodes", &listmasternodes, true, true, false},
        {"kubocoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"kubocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"kubocoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"kubocoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"kubocoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"kubocoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"kubocoin", "masternodedebug", &masternodedebug, true, true, false},
        {"kubocoin", "startmasternode", &startmasternode, true, true, false},
        {"kubocoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"kubocoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"kubocoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"kubocoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"kubocoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"kubocoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"kubocoin", "preparebudget", &preparebudget, true, true, false},
        {"kubocoin", "submitbudget", &submitbudget, true, true, false},
        {"kubocoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"kubocoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"kubocoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"kubocoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"kubocoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"kubocoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"kubocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"kubocoin", "checkbudgets", &checkbudgets, true, true, false},
        {"kubocoin", "mnsync", &mnsync, true, true, false},
        {"kubocoin", "spork", &spork, true, true, false},
        {"kubocoin", "getpoolinfo", &getpoolinfo, true, true, false},
        {"kubocoin", "makekeypair", &makekeypair, true, true, false},
...
//        {"wallet", "dumpwallethd", &dumpwallethd, true, false, true},
        ...
        {"zerocoin", "getzkuboseed", &getzkuboseed, false, false, true},
        {"zerocoin", "setzkuboseed", &setzkuboseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzkubo", &searchdzkubo, false, false, true},
        {"zerocoin", "dzkubostate", &dzkubostate, false, false, true},
...
{
    return "> kubocoin-cli " + methodname + " " + args + "\n";
}
