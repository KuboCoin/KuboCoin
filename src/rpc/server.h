...
/**
 * kubocoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzkuboseed(const UniValue& params, bool fHelp);
extern UniValue getzkuboseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzkubo(const UniValue& params, bool fHelp);
extern UniValue dzkubostate(const UniValue& params, bool fHelp);
