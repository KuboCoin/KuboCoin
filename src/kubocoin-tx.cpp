...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("KuboCoin Core kubocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  kubocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kubocoin transaction") + "\n" +
                               "  kubocoin-tx [options] -create [commands]   " + _("Create hex-encoded kubocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kubocoin transaction
