...
#ifndef kubocoin_zkuboWALLET_H
#define kubocoin_zkuboWALLET_H
...
public:
    CzkuboWallet(std::string strWalletFile);
    ...
    void GenerateDeterministiczkubo(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedTozkubo(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
