...
#ifndef kubocoin_zkuboTRACKER_H
#define kubocoin_zkuboTRACKER_H
...
public:
    CzkuboTracker(std::string strWalletFile);
    ~CzkuboTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzkuboWallet* zkuboWallet = NULL);
