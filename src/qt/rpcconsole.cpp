                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzkuboPathCustom = GetArg("-zkubobackuppath", "");
    ...
    if(!strzkuboPathCustom.empty()) {
        ui->wallet_customzkubobackuppath->setText(QString::fromStdString(strzkuboPathCustom));
        ui->wallet_customzkubobackuppath_label->setVisible(true);
        ui->wallet_customzkubobackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzkuboPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the KuboCoin RPC console.") + "<br>" +
