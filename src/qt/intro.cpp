...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("kuboCoin Core"),
     ...
     * override -datadir in the kubocoin.conf file in the default data directory
     * (to be consistent with kubocoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
