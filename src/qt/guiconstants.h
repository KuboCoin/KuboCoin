...
/* kubocoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "kuboCoin"
#define QAPP_ORG_DOMAIN "kubo.io"
#define QAPP_APP_NAME_DEFAULT "kubocoin-Qt"
#define QAPP_APP_NAME_TESTNET "kubocoin-Qt-testnet"
