...
public:
    ...
    void setzkuboControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzkubo_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzkubo_clicked();
    void on_pushButtonzkuboControl_clicked();
