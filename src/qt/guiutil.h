...
/** Utility functions used by the kubocoin Qt UI.
 */
namespace GUIUtil
{
...
// Render kubocoin addresses in monospace font
...
// Parse "kubocoin:" URI into recipient object, return true on successful parsing
