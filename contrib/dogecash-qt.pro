...
RESOURCES += src/qt/kubocoin.qrc src/qt/kubocoin_locale.qrc

TRANSLATIONS += src/qt/locale/kubocoin_bg.ts \
                src/qt/locale/kubocoin_de.ts \
                src/qt/locale/kubocoin_en.ts \
                src/qt/locale/kubocoin_es.ts \
                src/qt/locale/kubocoin_fi.ts \
                src/qt/locale/kubocoin_fr.ts \
                src/qt/locale/kubocoin_it.ts \
                src/qt/locale/kubocoin_ja.ts \
                src/qt/locale/kubocoin_pl.ts \
                src/qt/locale/kubocoin_pt.ts \
                src/qt/locale/kubocoin_ru.ts \
                src/qt/locale/kubocoin_sk.ts \
                src/qt/locale/kubocoin_sv.ts \
                src/qt/locale/kubocoin_vi.ts \
                src/qt/locale/kubocoin_zh_CN.ts \
                src/qt/locale/kubocoin_zh_TW.ts
