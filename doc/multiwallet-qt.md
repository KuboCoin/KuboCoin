...
In order to support loading of multiple wallets in kubocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kubocoin.cpp.
...
Changes to kubocoin.cpp
----------------------
kubocoin.cpp is the entry point into kubocoin-qt, and as such, will require some minor modifications to provide hooks for
