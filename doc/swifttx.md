...
This mechanism has been integrated into Bitcore-Node-kubocoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/kubocoin-Project/insight-api-kubocoin#web-socket-api](https://github.com/kubocoin-Project/insight-api-kubocoin#web-socket-api) 
* API: [https://github.com/kubocoin-Project/insight-api-kubocoin#swifttx-transactions](https://github.com/kubocoin-Project/insight-api-kubocoin#swifttx-transactions) 
